...
local themes = {
	...
	AirHub = {
		["Accent"] = Color3.fromRGB(2, 52, 90),
		["Window Background"] = Color3.fromRGB(35, 35, 30),
		["Window Border"] = Color3.fromRGB(50, 50, 45),
		["Tab Background"] = Color3.fromRGB(25, 25, 20),
		["Tab Border"] = Color3.fromRGB(65, 65, 85),
		["Tab Toggle Background"] = Color3.fromRGB(35, 35, 30),
		["Section Background"] = Color3.fromRGB(25, 25, 20),
		["Section Border"] = Color3.fromRGB(55, 35, 55),
		["Text"] = Color3.fromRGB(200, 200, 180),
		["Disabled Text"] = Color3.fromRGB(120, 120, 100),
		["Object Background"] = Color3.fromRGB(30, 30, 25),
		["Object Border"] = Color3.fromRGB(40, 40, 35),
		["Dropdown Option Background"] = Color3.fromRGB(25, 25, 20)
	}
}
...
function library.createdropdown(holder, content, flag, callback, default, max, scrollable, scrollingmax, islist, section, sectioncontent)
	...
	dropdown.MouseEnter:Connect(function()
		mouseover = true
		dropdown.Color = utility.changecolor(library.theme["Object Background"], 1)
	end)
	...
	dropdown.MouseButton1Down:Connect(function()
		dropdown.Color = utility.changecolor(library.theme["Object Background"], 2)
	end)
...
function library.createslider(min, max, parent, text, default, float, flag, callback)
	...
	slider.MouseEnter:Connect(function()
		mouseover = true
		if not sliding then
			slider.Color = utility.changecolor(library.theme["Object Background"], 1)
		end
	end)
	...
	utility.connect(slider.InputBegan, function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			sliding = true
			slider.Color = utility.changecolor(library.theme["Object Background"], 2)
			slide(input)
		end
	end)
	...
	utility.connect(slider.InputEnded, function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			sliding = false
			slider.Color = mouseover and utility.changecolor(library.theme["Object Background"], 1) or library.theme["Object Background"]
		end
	end)
...
function library.createcolorpicker(default, defaultalpha, parent, count, flag, callback)
	...
	rgbinput.MouseEnter:Connect(function()
		mouseover = true
		rgbinput.Color = utility.changecolor(library.theme["Object Background"], 1)
	end)
	...
	rgbinput.MouseButton1Down:Connect(function()
		rgbinput.Color = utility.changecolor(library.theme["Object Background"], 2)
	end)

	rgbinput.MouseButton1Up:Connect(function()
		rgbinput.Color = mouseover and utility.changecolor(library.theme["Object Background"], 1) or library.theme["Object Background"]
	end)
...
function library:Load(options)
	...
	function windowtypes:Tab(name)
		...
		tabtoggle.MouseEnter:Connect(function()
			mouseover = true
			tabtoggle.Color = tab.Visible == true and utility.changecolor(library.theme["Tab Toggle Background"], 2) or utility.changecolor(library.theme["Tab Background"], 1)
		end)
		...
		tabtoggle.MouseButton1Down:Connect(function()
			tabtoggle.Color = tab.Visible == true and utility.changecolor(library.theme["Tab Toggle Background"], 2) or utility.changecolor(library.theme["Tab Background"], 2)
		end)
		...
		tabtoggle.MouseButton1Click:Connect(function()
			...
			tabtoggle.Color = mouseover and utility.changecolor(library.theme["Tab Toggle Background"], 1) or utility.changecolor(library.theme["Tab Background"], 1)
		...
		function tabtypes:Section(options)
			...
			function sectiontypes:Button(options)
				...
				button.MouseEnter:Connect(function()
					mouseover = true
					button.Color = utility.changecolor(library.theme["Object Background"], 1)
				end)
				...
				button.MouseButton1Down:Connect(function()
					button.Color = utility.changecolor(library.theme["Object Background"], 2)
				end)

				button.MouseButton1Up:Connect(function()
					button.Color = mouseover and utility.changecolor(library.theme["Object Background"], 1) or library.theme["Object Background"]
				end)
			...
			function sectiontypes:Toggle(options)
				...
				icon.MouseEnter:Connect(function()
					if not toggled then
						mouseover = true
						icon.Color = utility.changecolor(library.theme["Object Background"], 1)
					end
				end)
				...
				icon.MouseButton1Down:Connect(function()
					if not toggled then
						icon.Color = utility.changecolor(library.theme["Object Background"], 2)
					end
				end)

				icon.MouseButton1Up:Connect(function()
					if not toggled then
						icon.Color = mouseover and utility.changecolor(library.theme["Object Background"], 1) or library.theme["Object Background"]
					end
				end)
				...
				local function setstate()
					...
					icon.Color = toggled and library.theme["Accent"] or (mouseover and utility.changecolor(library.theme["Object Background"], 1) or library.theme["Object Background"])
			...
			function sectiontypes:Box(options)
				...
				box.MouseEnter:Connect(function()
					mouseover = true
					box.Color = utility.changecolor(library.theme["Object Background"], 1)
				end)
				...
				box.MouseButton1Down:Connect(function()
					box.Color = utility.changecolor(library.theme["Object Background"], 2)
				end)

				box.MouseButton1Up:Connect(function()
					box.Color = mouseover and utility.changecolor(library.theme["Object Background"], 1) or library.theme["Object Background"]
				end)
