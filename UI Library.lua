...
local themes = {
	...
	AirHub = {
		...
		["Section Border"] = Color3.fromRGB(55, 55, 75),
		["Text"] = Color3.fromRGB(200, 200, 180),
		["Disabled Text"] = Color3.fromRGB(120, 120, 160),
		["Object Background"] = Color3.fromRGB(30, 30, 30),
		["Object Border"] = Color3.fromRGB(40, 40, 40),
		["Dropdown Option Background"] = Color3.fromRGB(25, 25, 25)
	}
}
...
function library:Load(options)
	...
	function windowtypes:Tab(name)
		...
		tabtoggle.MouseEnter:Connect(function()
			mouseover = true
			tabtoggle.Color = tab.Visible == true and utility.changecolor(library.theme["Tab Toggle Background"], 6) or utility.changecolor(library.theme["Tab Background"], 3)
		end)
